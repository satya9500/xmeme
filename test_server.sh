...
# git clone the repo
git clone https://gitlab.crio.do/COHORT_ME_BUILDOUT_XMEME_ENROLL_1612436694845/satya-prakash9500-me_buildout_xmeme.git
# cd to the cloned repo directory
cd satya-prakash9500-me_buildout_xmeme
